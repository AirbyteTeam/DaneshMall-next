...
export default function Companies() {
    ...
    const getCompany = async (page) => {
        const companyResponse = await axios.get(`http://localhost:8090/api/v1/company/${params.category}?page=${page - 1}&size=12`)
        ...
        <div className="">
            <div className='relative'>
                <div className="absolute top-[40%] w-full flex justify-center">
                    <h1 className="text-4xl font-bold">{persianCategory}</h1>
                </div>
