...
const AddCompany = () => {
  ...
  const getCompany = async (page) => {
    ...
    const companyResponse = await api.get(
      `company/findAll?page=${page - 1}&size=6`
    );
  ...
  const getCategory = async () => {
    await axios
      .get("http://localhost:8090/api/v1/company/categories")
      .then((res) => {
  ...
  return (
    <>
                    ...
                    <tr>
                      ...
                      <td className="flex justify-center items-center">
                        <div className="p-2">
                          <img
                            src={co.logoUrl}
                            className="w-[4rem] h-[4rem]   object-cover rounded-xl"
                            alt="Logo"
                          />
                        </div>
                      </td>
      ...
      >
        <DialogTitle style={{ fontFamily: "Vazirmatn RD FD" }}>
          افزودن شرکت جدید
        </DialogTitle>
        <DialogContent>
        ...
        <DialogActions className="gap-3" style={{ justifyContent: "center" }}>
          ...
          <button
            className="bg-red-500 hover:opacity-80 py-2 px-4 rounded-xl"
            onClick={handleCloseAddCompany}
          >
            بستن
          </button>
        </DialogActions>
          ...
          <DialogContentText style={{ fontFamily: "Vazirmatn RD FD" }}>
            <div>
              ...
              <div className="mb-6">
                ...
                <input
                  value={editCompany.companyFullName}
                  onChange={(e) => {
                    setEditCompany((co) => ({
                      ...co,
                      companyFullName: e.target.value,
              ...
              <div>
                {!isUpload ? (
                  ...
                  >
                    ...
                    <div className="flex items-center">
                      <h6 className="mx-1">
                        {logoImageEdit && logoImageEdit.name}
                      </h6>
                      <RiFileUploadFill className="text-[#83b230] text-2xl" />
                    </div>
                  </div>
